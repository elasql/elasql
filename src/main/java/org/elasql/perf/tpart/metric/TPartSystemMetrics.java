...
public class TPartSystemMetrics implements MetricReport {
	...
	public static class Builder {
		...
		public void setLatchFeatures(String latchFeatures) {
			this.latchFeatures = latchFeatures;
		}
		...
		public TPartSystemMetrics build() {
			...
			metrics.latchFeatures = latchFeatures;
	...
	public String getLatchFeatures() {
