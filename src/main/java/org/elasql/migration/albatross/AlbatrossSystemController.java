...
public class AlbatrossSystemController implements MigrationSystemController {
	private static Logger logger = Logger.getLogger(AlbatrossSystemController.class.getName());
	
	private AtomicInteger numOfRangesToBeMigrated = new AtomicInteger(0);
	
	private MigrationComponentFactory comsFactory;
	
	public AlbatrossSystemController(MigrationComponentFactory comsFactory) {
